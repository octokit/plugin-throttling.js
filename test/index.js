...
describe('Github API best practices', function () {
  ...
  it('Should maintain 1000ms between mutating requests', async function () {
    ...
    expect(octokit.__requestTimings[4] - octokit.__requestTimings[2]).to.be.closeTo(50, 10)
  })
  ...
  it('Should maintain 3000ms between requests that trigger notifications', async function () {
    ...
    expect(octokit.__requestTimings[5] - octokit.__requestTimings[0]).to.be.closeTo(100, 10)
  })
  ...
  it('Should optimize throughput rather than maintain ordering', async function () {
    ...
    expect(octokit.__requestTimings[2] - octokit.__requestTimings[0]).to.be.closeTo(0, 10)
    expect(octokit.__requestTimings[4] - octokit.__requestTimings[2]).to.be.closeTo(0, 10)
    expect(octokit.__requestTimings[6] - octokit.__requestTimings[4]).to.be.closeTo(50, 10)
    expect(octokit.__requestTimings[8] - octokit.__requestTimings[6]).to.be.closeTo(50, 10)
    expect(octokit.__requestTimings[10] - octokit.__requestTimings[8]).to.be.closeTo(100, 10)
    expect(octokit.__requestTimings[12] - octokit.__requestTimings[10]).to.be.closeTo(0, 10)
  })
})
